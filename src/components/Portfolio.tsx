            ...
            return (
               ...
               >
                 ...
                 <div className="absolute bottom-0 inset-x-0 p-6 flex flex-col gap-2">
                   {/* Category chip */}
                   <span
                     className="self-start px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider mb-1 transition-all duration-300 group-hover:bg-[var(--gold)] group-hover:text-[var(--navy)]"
                     style={{
                   ...
                   <motion.div
                     ...
                     className="mt-2"
                   >
                     <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[var(--gold)] group-hover:gap-2 transition-all duration-300">
                       {t('portfolio.view')}
